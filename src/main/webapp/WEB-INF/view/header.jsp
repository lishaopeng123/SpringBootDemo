...
<body>
	...
	<div style="width: 100%">
		...
		<div id="top">
			<span id="span1" style="margin-left: 450px;"> <a href="/">360官网</a>|<a
				href="/">360社区</a>
			</span> <span id="span2" style="margin-right: 450px;"> <span
				id="span3"><a href="login">登录</a> | <a href="register">注册</a></span>
		...
		<div id="banner">
			...
			<form action="good/fuzzy" method="post">
				<span style="margin-right: 450px;"> <input type="text"
					name="goods" id="input1" value="360手机" /> <input type="submit"
					value="搜索" id="input2" />
				</span>
			</form>
		</div>
