		...
		$("#tijiao").click(
				function() {
					if ($("#user").val().length > 3
						...
						$("#v6").css("font-size", "13px").css("color", "#F00")
...
#div2 {
	background: url("img/register.jpg") -80px -150px no-repeat;
	margin-left: 200px;
}
</style>
</head>
<body>
	<div style="width: 100%;">
		<div id="div1">
			<img src="img/logo_login.png" /> <span
				style="margin-left: 50px; color: #333; font-weight: bold; font-size: 20px">欢迎注册</span>
			<span
				style="margin-left: 600px; color: #333; font-weight: bold; font-size: 14px">已有账号<a
		...
		<div id="div2">
			<form action="userInfo/reg" method="post">
				<table width="511px" cellspacing="4px" cellpadding="1px"
					...
					<tr>
						<td height="74"
							style="font-size: 13px; font-weight: bold; color: white">请输入密码</td>
					...
					<tr>
						<td height="73"
							style="font-size: 13px; font-weight: bold; color: white">再次输入密码</td>
						<td colspan="2"><input type="password"
							placeholder="限制数字、字母、下划线，6-20长度！"
							style="display: block; width: 250px; height: 35px" id="pass1" /></td>
						<td id="v3">&nbsp;</td>
					</tr>
					<tr>
						<td height="85"
					...
					<tr>
						<td height="44" colspan="4" style="font-size: 13px"><input
							type="checkbox" checked="checked" />我已阅读并同意<a href="/">《360用户注册协议》</a></td>
					</tr>
					<tr>
						<td height="55" colspan="4"><img src="img/zhuce.png"
