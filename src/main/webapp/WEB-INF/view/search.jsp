...
<html>
  ...
  <c:if test="${!empty listgoods}">
    <div id=father>
    		...
    		<dl>
    			<dt><a href="good/det?id=${goods.getId()}"><img src="${path}/img/${goods.getImg1()}"/></a></dt>
    			<dd><a href="good/det?id=${goods.getId()}">${goods.getName()}</a></dd>
    			<dd><a href="good/det?id=${goods.getId()}">${goods.getPrice()}元</a></dd>
    		</dl>
    		</c:forEach>
    		</div>
    		<%@ include file="footer.jsp" %>
